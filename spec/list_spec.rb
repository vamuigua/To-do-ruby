  ...
  describe(List) do
    ...
    describe("#name") do
      it("tells you its name") do
        list = List.new({:name => "moringaschool stuff", :id => 1})
    ...
    describe("#==") do
      it("is the same list if it has the same name") do
        list1 = List.new({:name => "moringaschool stuff", :id => 1})
        list2 = List.new({:name => "moringaschool stuff", :id => 1})
    ...
    describe(".find") do
      it("returns a list by its ID") do
        test_list = List.new({:name => "Moringaschool stuff", :id => 1})
        test_list.save()
        test_list2 = List.new({:name => "Home stuff", :id => 1})
        test_list2.save()
