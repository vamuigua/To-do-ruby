...
describe(List) do
  ...
  #spec to return the id of a list
  describe("#id") do
    it("returns the ID of the list when you save it") do
      list = List.new({:name => "moringaschool stuff", :id => nil})
      list.save()
  ...
  describe("#tasks") do
    it("returns an array of tasks for that list") do
      ...
      test_task.save()
      test_task2 = Task.new({:description => "Review Ruby", :id => nil})
      test_task2.save()
      test_list.add_task(test_task.id())
      test_list.add_task(test_task2.id())
  ...
  describe("#delete") do
    ...
    it("deletes a list's tasks from the database") do
      list = List.new({:name => "Moringa School stuff", :id => nil})
      list.save()
      task = Task.new({:description => "learn SQL", :id => nil})
      task.save()
